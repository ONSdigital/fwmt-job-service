...
public class LegacySampleIteratorTests {
  ...
  @Test
  public void givenSampleIsLFS_whenIngesting_verifyItsParsedAsLFS() throws IOException {
  ...
  @Test
  public void givenSampleIsGFF_whenIngesting_verifyItsParsedAsGFF() throws IOException {
    Reader reader = mock(Reader.class);
    CSVParser csvParser = new CSVParser(reader, CSVFormat.DEFAULT.withHeader(""));
  ...
  @Test
  public void givenSampleIsLFS_whenIngesting_verifyItsParsesCommon() throws IOException {
    Reader reader = mock(Reader.class);
    CSVParser csvParser = new CSVParser(reader, CSVFormat.DEFAULT.withHeader(""));
  ...
  @Test
  public void givenSampleIsGFF_whenIngesting_verifyItsParsesCommon() throws IOException {
    Reader reader = mock(Reader.class);
    CSVParser csvParser = new CSVParser(reader, CSVFormat.DEFAULT.withHeader(""));
