...
public class ResourceServiceUnauthenticatedException extends FWMTCommonException {
  static public final long serialVersionUID = 0L;

  public ResourceServiceUnauthenticatedException() {
    super(ExceptionCode.RESOURCE_SERVICE_UNAUTHENTICATED, "The resource service rejected our credentials");
  }

  public ResourceServiceUnauthenticatedException(Throwable cause) {
    super(ExceptionCode.RESOURCE_SERVICE_UNAUTHENTICATED, "The resource service rejected our credentials", cause);
  }

  public ResourceServiceUnauthenticatedException(String message) {
    super(ExceptionCode.RESOURCE_SERVICE_UNAUTHENTICATED,
