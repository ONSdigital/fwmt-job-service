...
public class LegacySampleIterator<LegacySampleIngest> extends CSVIterator<LegacySampleIngest> {

  private LegacySampleSurveyType legacySampleSurveyType;
  private LegacySampleIngest instance;

  protected LegacySampleIterator(CSVParser parser, LegacySampleSurveyType legacySampleSurveyType) {
    super(parser);
    this.legacySampleSurveyType = legacySampleSurveyType;
    instance = new LegacySampleIngest();
  }
